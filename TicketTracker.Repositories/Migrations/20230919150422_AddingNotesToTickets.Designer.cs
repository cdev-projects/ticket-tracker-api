...
namespace TicketTracker.Repositories.Migrations
{
    ...
    [Migration("20230919150422_AddingNotesToTickets")]
    partial class AddingNotesToTickets
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TicketTracker.Repositories.Tickets.Entities.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = -1,
                            CreatedById = 1,
                            CreatedTimestamp = new DateTime(2023, 9, 19, 15, 4, 22, 649, DateTimeKind.Utc).AddTicks(9277),
                            Description = "Customer onboarding screen needs to be developed so that customers can be dynamically added into the system.",
                            LastModifiedById = 1,
                            LastModifiedTimestamp = new DateTime(2023, 9, 19, 15, 4, 22, 649, DateTimeKind.Utc).AddTicks(9278),
                            Status = 1,
